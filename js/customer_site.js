...
ruyi: {name: '*如意资源',api: 'https://cj.rycjapi.com/api.php/provide/vod/',},baofeng: {
name: '*暴风资源',api: 'https://bf.xoxowin86cisyap.com//api.php/provide/vod/',},
maotai: {name: '*茅台资源',api: 'https://caiji.maotaizy.cc/api.php/provide/vod/from/mtm3u8/',},
360: {name: '*360资源',api: 'https://360zy.com/api.php/provide/vod/',},
mozhua: {name: '*魔爪资源',api: 'https://mozhuazy.com/api.php/provide/vod/',},siquan: {
name: '*四个圈',api: 'https://pg.fenwe078.cf/api.php/provide/vod/',},
...
feifan: {name: '*非凡资源',api: 'http://api.ffzyapi.com/api.php/provide/vod/',},youzhi: {
name: '*优质资源',api: 'https://api.yzzy-api.com/inc/api_mac10.php?ac',},
wujing: {name: '*无尽资源',api: 'https://api.wujinapi.cc/api.php/provide/vod/',},
